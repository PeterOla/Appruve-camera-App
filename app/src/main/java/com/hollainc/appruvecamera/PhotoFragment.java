...
public class PhotoFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public interface OnFragmentInteractionListener {
        void onFragmentInteraction(Bitmap bitmap, String path);
    }
...
//                }
    ...
    private void createImageFile(final Bitmap bitmap) {
        ...
        @SuppressLint("SimpleDateFormat") String timeStamp = new SimpleDateFormat("MMdd_HHmmssSSS").format(new Date());
...
//            Toast.makeText(context, file.getName(), Toast.LENGTH_SHORT).show();
            ...
            if (mListener != null) {
                if (bitmap != null)
                    mListener.onFragmentInteraction(bitmap, file.toString());
            }
        } catch (Exception e) {
